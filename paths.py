...
browser = 'Firefox' # какой браузер используем
driver_path = r'./firefoxdriver.exe' # путь к драйверу
...
visual_check_time = 5 # время на визуальный контроль выполненных действий
